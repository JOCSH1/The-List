...
Una lista (valga la redundancia) de juegos de todo género, plataforma, duración, precios, gráficos e idiomas, (excepto My Femboy Roommate, al que recomiende esa porquería de juego lo mataré con mis propias manos) para que cada persona amante de los videojuegos, que quiera añadirle provecho a su tiempo jugando, pueda consultarla, y encontrar juegos del estilo que más prefiera, y en el idioma que quiere aprender.
Recomendaría recomendarlos específicando para qué plataforma es el juego, el género del juego, el valor (de preferencia gratis), si es un juego de mucho texto (como Mario & Luigi Superstar Saga), un peli-juego (creo que The Last of Us y Red Dead Redemption califican como tal), un juego con chat o chat de voz, etc
